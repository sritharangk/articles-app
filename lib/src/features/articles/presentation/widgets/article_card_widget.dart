...
import 'package:articles_app/src/core/router/app_route_enum.dart';
import 'package:articles_app/src/core/styles/app_colors.dart';
import 'package:articles_app/src/core/utils/constant/app_constants.dart';
import 'package:articles_app/src/features/articles/domain/models/article_model.dart';
import 'package:articles_app/src/shared/presentation/widgets/cached_image_widget.dart';
...
class _ArticleCardWidgetState extends State<ArticleCardWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.nyTimesModel.media != null && widget.nyTimesModel.media!.isNotEmpty) {
      if (widget.nyTimesModel.media!.first.mediaMetadata != null && widget.nyTimesModel.media!.first.mediaMetadata!.isNotEmpty) {
    ...
    // else display solid circle instead
    if (widget.nyTimesModel.media != null && widget.nyTimesModel.media!.isNotEmpty) {
      if (widget.nyTimesModel.media!.last.mediaMetadata != null && widget.nyTimesModel.media!.last.mediaMetadata!.isNotEmpty) {
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: Theme.of(context).textTheme.bodyLarge!.copyWith(color: AppColors.darkGray),
                ),
                  ...
                  children: [
                    ...
                    Flexible(
                      child: Text(
                        ...
                        style: Theme.of(context).textTheme.titleSmall!.copyWith(color: AppColors.darkGray),
